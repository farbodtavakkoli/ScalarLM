...
def materialize_model(model_info):
    ...
    # Load appropriate model type based on training mode
    if training_mode == "embedding":
        ...
        # Change made here - Was trying to see if it matters to put the model into GPU before FSDP
        # device = model_info["distribution_strategy"]["device"]
        ...
        logger.info("Loading model for language model training (AutoModelForCausalLM)...")
